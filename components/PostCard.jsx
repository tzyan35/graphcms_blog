...
const PostCard = ({post}) => {
  return (
    <div className="bg-white shadow-lg round-lg p-0 lg:p-8 pb-12 mb-8">
        ...
        <h1 className="transition duration-100 text-center cursor-pointer mb-8
        hover:text-pink-600 text-3x1 font-semibold ">
